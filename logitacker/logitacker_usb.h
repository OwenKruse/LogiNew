...
typedef enum {
    ...
    LOGITACKER_USB_HIDRAW_COMMAND_SCRIPT_INJECT = 0x16,
    LOGITACKER_USB_HIDRAW_COMMAND_SCRIPT_MOUSE_LIGHTSPEED = 0x17,
    LOGITACKER_USB_HIDRAW_COMMAND_INJECT_TARGET = 0x18,
    LOGITACKER_USB_HIDRAW_COMMAND_PASSIVE_ENUM = 0x19,
